      ...
      <div className="mx-auto max-w-4xl">
        <div className="grid gap-3 xl:grid-cols-[260px_1fr]">
          ...
          <div className="space-y-3">
            <div className="min-h-63 rounded-xl bg-[#FFFFFF] px-5 py-6 text-center shadow-sm ring-1 ring-slate-200/70">
              <img
                src={friend.picture}
                alt={friend.name}
              ...
              <div className="mt-2 flex flex-wrap min-h-7 justify-center gap-2">
            ...
            <button
              className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-white text-md font-medium text-[#1F2937] shadow-sm ring-1 ring-slate-200/70
            "
            >
              <BellRing size={18} className="translate-y-1" />
              Snooze 2 Weeks
            </button>
            <button
              className="flex  h-12 w-full items-center justify-center gap-2 rounded-xl bg-white text-md font-medium text-[#1F2937] shadow-sm ring-1 ring-slate-200/70
            "
            >
              <Archive size={16} className="translate-y-1" />
              Archive
            </button>
            <button
              className="flex  h-12 w-full items-center justify-center gap-2 rounded-xl bg-white text-md font-medium text-[#EF4444] shadow-sm ring-1 ring-slate-200/70
            "
            >
              <Trash2 size={16} className=" translate-y-1" />
              Delete
            </button>
          </div>
          {/* right */}
