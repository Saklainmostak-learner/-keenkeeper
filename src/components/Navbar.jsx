          ...
          {navItems.map((item) => {
            ...
            return (
              <NavLink
                ...
                className={({ isActive }) =>
                  `inline-flex items-center gap-2 rounded-sm px-4 py-2 text-sm font-semibold transition-all duration-100 leading-none ${isActive?"bg-[#1f5f4a] text-white shadow-sm":"text-[#64748B] hover:bg-slate-100 hover:text-slate-800"}`
                }
              >
